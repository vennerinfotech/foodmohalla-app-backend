		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Add Grab Best-Deal</h4>
						<p class="mb-30"></p>
					</div>
					<div class="wizard-content">
						<form action="process/addbestdeal.php" method="POST" enctype="multipart/form-data">	
							<section> 
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dname" name="dname" placeholder="Enter Your Deal Name" required>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<textarea class="form-control" type="text" class="form-control"  id="txtdescription" name="txtdescription" placeholder="Enter Your Product Description" style="height: 60px; width: 553px;" required></textarea>
										</div>
									</div>
                                    <div class="col-md-6">
                                        <div class="form-group">
