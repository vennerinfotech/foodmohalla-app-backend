...
$bdetail = $_POST['bdetail'];
                ...
                $result = mysqli_query($conn,"update banners set banner_name='$bname',banner_detail='$bdetail',image_url='$newname',updated_at='$date' where id='$id'") or die(mysqli_error($conn));
