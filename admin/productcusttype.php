...
<?php
$id = $_REQUEST['id'];
$sql = "select * from product_customize_types where id = '$id'"; 
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Product Customize Type</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Product Customize Type</h4>
						<p class="mb-30"></p>
					</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="iname" name="iname" placeholder="Enter Your Product" value="<?php echo $row["name"]; ?>" required>
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img src="Upload/Product/<?php echo $row["image_url"]; ?>" style="height: 80px; width: 80px;" />
                                            </div>
                                    </div>
                                    <div class="col-md-6">
										<div class="form-group">
