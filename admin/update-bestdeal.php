...
<?php
	$id = $_REQUEST['id'];
	$sql = "select * from grab_best_deal where id = '$id'"; 
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Grab Best Deal</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Update Grab Best Deal</h4>
						<p class="mb-30"></p>
					</div>
					<div class="wizard-content">
						<form action="process/updatebestdeal.php" method="POST" enctype="multipart/form-data">	
							<section>
								<div class="row"> 
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="dname" name="dname" placeholder="Enter Your Best Deal" value="<?php echo $row["deal_name"]; ?>" required>
								...
								<div class="row"> 
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Grab Deal Image :</label>
                                                <input type="file" class="form-control" id="image" name="image" placeholder="Enter Image">

                                                <input type="hidden" name="oldimg" value="<?php echo $row["thumbnail_img_url"]; ?>">
                                                <img src="Upload/Bestdeal/<?php echo $row["thumbnail_img_url"]; ?>" style="height: 80px; width: 80px;" />
                                            </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                                ...
                                                <img src="Upload/Bestdeal-Banner/<?php echo $row["banner_img_url"]; ?>" style="height: 80px; width: 80px;" />
                                        </div>
                                    </div>
