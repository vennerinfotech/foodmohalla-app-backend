...
<?php
	$id = $_REQUEST['id'];
	$sql = "select * from best_offer where id = '$id'";
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Update Offer Details</h4>
						<p class="mb-30"></p>
					</div>
					<div class="wizard-content">
						<form method="POST" enctype="multipart/form-data" action="process/updatebestoffer.php">
							<section>
								<div class="row">
									<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<img src="Upload/Best_Offer/<?php echo $row["image_url"]; ?>" style="height: 80px; width: 80px;" />
										</div>
									</div>
