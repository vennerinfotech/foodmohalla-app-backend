		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Update Delivery Boy Details</h4>
						<p class="mb-30"></p>
					</div>
					<div class="wizard-content">
						<form method="POST" enctype="multipart/form-data" action="process/updatedeliveryboy.php">		
							<section>
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control"  id="bdetail" name="bdetail" placeholder="Enter Your Delivery Boy Name" value="<?php echo $row["name"]; ?>" required>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="lurl" name="lurl" placeholder="Enter Delievry Boy Phone No" value="<?php echo $row["phone_no"]; ?>" required>
										</div>
									</div>
									<div class="col-md-6">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Address :</label>
                                                <input type="text" class="form-control" id="badd" name="badd" placeholder="Enter Delievry Boy Address"  style="width: 218%; height: 70px;" value="<?php echo $row["address"]; ?>" required>
                                            </div>
                                        </div>
									</div>
