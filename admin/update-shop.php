		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<h4 class="text-blue h4">Update Shop</h4>
						<p class="mb-30"></p>
					</div>
					<div class="wizard-content">
						<form action="process/updateshop.php" method="POST" enctype="multipart/form-data">	
							<section>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label >Shop Name :</label>
											<input type="text" id="sname" name="sname" placeholder="Enter Your Shop Name" class="form-control" value="<?php echo $row["shop_name"]; ?>" required>
									...
									<div class="col-md-6">
										<div class="form-group">
                                            ...
                                            <textarea class="form-control" type="text" class="form-control"  id="txtlandmark" name="txtlandmark" placeholder="Enter Your Shop Address" style="height: 60px; width: 553px;" value="<?php echo $row["address"]; ?>" required></textarea>
										</div>
									</div>
								</div>
                                    <div class="col-md-12">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="number" class="form-control" id="cnumber" name="cnumber" placeholder="Enter Contact Number" value="<?php echo $row["contact_number"]; ?>" required>
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
											<label>Latitude :</label>
											<input type="text" class="form-control" id="txtlatitude" name="txtlatitude" placeholder="..." value="<?php echo $row["latitude"]; ?>" required>
										</div>
									</div>
                                    <div class="col-md-6">
										<div class="form-group">
											<label>Longitude :</label>
											<input type="text" class="form-control" id="txtlongitude" name="txtlongitude" placeholder="Enter Contact Number" value="<?php echo $row["longitude"]; ?>" required>
										</div>
									</div>
