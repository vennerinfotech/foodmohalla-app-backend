		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">View Shops Details</li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">View Shops</h4>
					</div>
					<div class="pb-20">
						...
						<table  class="data-table table stripe hover">
							...
							<tbody>
                                <?php
                                    $count=1;	
                                    $result=mysqli_query($conn,"SELECT * FROM `shops`") or die(mysqli_error($conn));
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												<a class="dropdown-item" href="update-shop.php?id=<?php echo $row["id"]; ?>"><i class="dw dw-edit2"></i> Edit</a>
												<a class="dropdown-item" href="process/deleteshop.php?id=<?php echo $row["id"]; ?>"><i class="dw dw-delete-3"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
